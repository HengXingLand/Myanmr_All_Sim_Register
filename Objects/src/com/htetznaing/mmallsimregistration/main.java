...
public static String  _about_click() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub about_Click";
 //BA.debugLineNum = 171;BA.debugLine="StartActivity(lollipop)";
...
_imvlogo.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icon.png").getObject()));
 //BA.debugLineNum = 86;BA.debugLine="imvLogo.Gravity = Gravity.FILL";
_imvlogo.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 87;BA.debugLine="Activity.AddView ( imvLogo , 50%x - 50dip  , 10di";
mostCurrent._activity.AddView((android.view.View)(_imvlogo.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)));
 //BA.debugLineNum = 89;BA.debugLine="Dim divBar,divBar1 As Panel";
_divbar = new anywheresoftware.b4a.objects.PanelWrapper();
_divbar1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 90;BA.debugLine="divBar.Initialize (\"\")";
_divbar.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 91;BA.debugLine="divBar.Color = Colors.LightGray";
_divbar.setColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 //BA.debugLineNum = 92;BA.debugLine="Activity.AddView (divBar , 18dip , imvLogo.Height";
mostCurrent._activity.AddView((android.view.View)(_divbar.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (18)),(int) (_imvlogo.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25))),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (36))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)));
 //BA.debugLineNum = 94;BA.debugLine="lblTitle.Initialize (\"\")";
mostCurrent._lbltitle.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 95;BA.debugLine="lblTitle.Text = \"Myanmar All Sim Register!\"";
mostCurrent._lbltitle.setText((Object)("Myanmar All Sim Register!"));
 //BA.debugLineNum = 96;BA.debugLine="lblTitle.TextColor = Colors.RGB(0,136,82)";
mostCurrent._lbltitle.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (136),(int) (82)));
 //BA.debugLineNum = 97;BA.debugLine="lblTitle.TextSize = 20";
mostCurrent._lbltitle.setTextSize((float) (20));
 //BA.debugLineNum = 98;BA.debugLine="lblTitle.Gravity = Gravity.CENTER";
mostCurrent._lbltitle.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 99;BA.debugLine="Activity.AddView (lblTitle, 10dip , (divBar.Top+d";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lbltitle.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) ((_divbar.getTop()+_divbar.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 100;BA.debugLine="lblTitle.Height = su.MeasureMultilineTextHeight (";
mostCurrent._lbltitle.setHeight(mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(mostCurrent._lbltitle.getObject()),mostCurrent._lbltitle.getText()));
 //BA.debugLineNum = 102;BA.debugLine="lblFooter.Initialize (\"lblFooter\")";
mostCurrent._lblfooter.Initialize(mostCurrent.activityBA,"lblFooter");
 //BA.debugLineNum = 103;BA.debugLine="lblFooter.Text = \"Developed By Khun Htetz Naing\"";
mostCurrent._lblfooter.setText((Object)("Developed By Khun Htetz Naing"));
 //BA.debugLineNum = 104;BA.debugLine="lblFooter.TextColor = Colors.RGB(156,39,176)";
mostCurrent._lblfooter.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (156),(int) (39),(int) (176)));
 //BA.debugLineNum = 105;BA.debugLine="lblFooter.TextSize = 12";
mostCurrent._lblfooter.setTextSize((float) (12));
 //BA.debugLineNum = 106;BA.debugLine="lblFooter.Gravity = Gravity.CENTER";
mostCurrent._lblfooter.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 108;BA.debugLine="divBar1.Initialize (\"\")";
_divbar1.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 109;BA.debugLine="divBar1.Color = Colors.LightGray";
_divbar1.setColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 //BA.debugLineNum = 110;BA.debugLine="Activity.AddView (divBar1 , 18dip , (lblTitle.Hei";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._btelenor.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 134;BA.debugLine="Activity.AddView(bMPT,15%x,(bTelenor.Top+bTelenor";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._bmpt.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) ((mostCurrent._btelenor.getTop()+mostCurrent._btelenor.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 135;BA.debugLine="Activity.AddView(bOoredoo,15%x,(bMPT.Top+bMPT.Hei";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._booredoo.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) ((mostCurrent._bmpt.getTop()+mostCurrent._bmpt.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 136;BA.debugLine="Activity.AddView(AdView1, 0%x,85%y, 100%x, 10%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._adview1.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (85),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 137;BA.debugLine="Activity.AddView(bMEC,15%x,(bOoredoo.Top+bOoredoo";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._bmec.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) ((mostCurrent._booredoo.getTop()+mostCurrent._booredoo.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 138;BA.debugLine="Activity.AddView (lblFooter , 10dip,95%y, 100%x -";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lblfooter.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (95),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 140;BA.debugLine="Activity.AddMenuItem(\"Stop Showing Ads!\",\"rad\")";
mostCurrent._activity.AddMenuItem("Stop Showing Ads!","rad");
 //BA.debugLineNum = 141;BA.debugLine="Activity.AddMenuItem(\"Change Theme\",\"ct\")";
mostCurrent._activity.AddMenuItem("Change Theme","ct");
 //BA.debugLineNum = 142;BA.debugLine="Activity.AddMenuItem3(\"Share App\",\"share\",LoadBit";
mostCurrent._activity.AddMenuItem3("Share App","share",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"share.png").getObject()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 143;BA.debugLine="Activity.AddMenuItem(\"How to Use.?\",\"help\")";
mostCurrent._activity.AddMenuItem("How to Use.?","help");
 //BA.debugLineNum = 144;BA.debugLine="Activity.AddMenuItem(\"About\",\"about\")";
mostCurrent._activity.AddMenuItem("About","about");
 //BA.debugLineNum = 145;BA.debugLine="Activity.AddMenuItem(\"Call SIM Operator\",\"cso\")";
mostCurrent._activity.AddMenuItem("Call SIM Operator","cso");
 //BA.debugLineNum = 147;BA.debugLine="t.Initialize(\"t\",15000)";
...
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 149;BA.debugLine="t1.Initialize(\"t1\",100)";
...
_t.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 152;BA.debugLine="Activity.AddView(wv,0%x,0%y,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._wv.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 153;BA.debugLine="Activity.AddView(bstart,60%x,87%y,35%x,8%y)";
...
int _answ = 0;
 //BA.debugLineNum = 424;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 425;BA.debugLine="Dim Answ As Int";
_answ = 0;
 //BA.debugLineNum = 426;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 427;BA.debugLine="Answ = Msgbox2(\"Do you want to Exit App?\", \"At";
_answ = anywheresoftware.b4a.keywords.Common.Msgbox2("Do you want to Exit App?","Attention!","Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 428;BA.debugLine="If Answ = DialogResponse.NEGATIVE Then";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 433;BA.debugLine="If Answ = DialogResponse.POSITIVE Then";
if (_answ==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 434;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 391;BA.debugLine="AdView1.Pause";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 395;BA.debugLine="AdView1.Resume";
mostCurrent._adview1.Resume();
 //BA.debugLineNum = 396;BA.debugLine="End Sub";
return "";
}
public static String  _ad_adscreendismissed() throws Exception{
 //BA.debugLineNum = 406;BA.debugLine="Sub Ad_AdScreenDismissed";
 //BA.debugLineNum = 407;BA.debugLine="Log(\"screen dismissed\")";
...
public static String  _ad_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 398;BA.debugLine="Sub Ad_FailedToReceiveAd (ErrorCode As String)";
 //BA.debugLineNum = 399;BA.debugLine="Log(\"failed: \" & ErrorCode)";
anywheresoftware.b4a.keywords.Common.Log("failed: "+_errorcode);
 //BA.debugLineNum = 400;BA.debugLine="End Sub";
return "";
}
public static String  _ad_receivead() throws Exception{
 //BA.debugLineNum = 402;BA.debugLine="Sub Ad_ReceiveAd";
 //BA.debugLineNum = 403;BA.debugLine="Log(\"received\")";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 314;BA.debugLine="Sub bMEC_Click";
 //BA.debugLineNum = 315;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 316;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 317;BA.debugLine="StartActivity(p.OpenBrowser(\"http://reg.mectel.co";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 320;BA.debugLine="Sub bMEC_LongClick";
 //BA.debugLineNum = 321;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 322;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:01391814\")";
_i.Initialize(_i.ACTION_VIEW,"tel:01391814");
 //BA.debugLineNum = 323;BA.debugLine="StartActivity(i)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 290;BA.debugLine="Sub bMPT_Click";
 //BA.debugLineNum = 291;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 292;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 293;BA.debugLine="StartActivity(p.OpenBrowser(\"https://care.mpt.com";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 296;BA.debugLine="Sub bMPT_LongClick";
 //BA.debugLineNum = 297;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 298;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:106\")";
_i.Initialize(_i.ACTION_VIEW,"tel:106");
 //BA.debugLineNum = 299;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 302;BA.debugLine="Sub bOoredoo_CLick";
 //BA.debugLineNum = 303;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 304;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 305;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.ooredoo.c";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 308;BA.debugLine="Sub bOoredoo_LongClick";
 //BA.debugLineNum = 309;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 310;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:234\")";
_i.Initialize(_i.ACTION_VIEW,"tel:234");
 //BA.debugLineNum = 311;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 //BA.debugLineNum = 312;BA.debugLine="End Sub";
return "";
}
public static String  _bstart_click() throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Sub bstart_Click";
 //BA.debugLineNum = 157;BA.debugLine="wv.Visible = False";
mostCurrent._wv.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 158;BA.debugLine="bstart.Visible = False";
mostCurrent._bstart.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 159;BA.debugLine="fb.Hide(False)";
mostCurrent._fb.Hide(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 160;BA.debugLine="fb1.Hide(False)";
mostCurrent._fb1.Hide(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 161;BA.debugLine="fb.Show(True)";
mostCurrent._fb.Show(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 162;BA.debugLine="fb1.Show(True)";
mostCurrent._fb1.Show(anywheresoftware.b4a.keywords.Common.True);
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 278;BA.debugLine="Sub bTelenor_Click";
 //BA.debugLineNum = 279;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 280;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 281;BA.debugLine="StartActivity(p.OpenBrowser(\"https://ecaf.telenor";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 284;BA.debugLine="Sub bTelenor_LongClick";
 //BA.debugLineNum = 285;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 286;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:979\")";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 174;BA.debugLine="Sub cso_Click";
 //BA.debugLineNum = 175;BA.debugLine="Dim a As Int";
_a = 0;
 //BA.debugLineNum = 176;BA.debugLine="Dim b As id";
_b = new com.maximus.id.id();
 //BA.debugLineNum = 177;BA.debugLine="Dim li As List";
_li = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 178;BA.debugLine="li.Initialize";
_li.Initialize();
 //BA.debugLineNum = 179;BA.debugLine="li.AddAll(Array As String(\"Call TELENOR Operator\"";
_li.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Call TELENOR Operator","Call MPT Operator","Call OOREDOO Operator","Call MECTEL Operator"}));
 //BA.debugLineNum = 180;BA.debugLine="a = b.InputList1(li,\"Choose Your Operator!\")";
_a = _b.InputList1(_li,"Choose Your Operator!",mostCurrent.activityBA);
 //BA.debugLineNum = 181;BA.debugLine="If a = 0 Then";
if (_a==0) { 
 //BA.debugLineNum = 182;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 183;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:979\")";
_i.Initialize(_i.ACTION_VIEW,"tel:979");
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 186;BA.debugLine="If a = 1 Then";
if (_a==1) { 
 //BA.debugLineNum = 187;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 188;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:106\")";
_i.Initialize(_i.ACTION_VIEW,"tel:106");
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 191;BA.debugLine="If a = 2 Then";
if (_a==2) { 
 //BA.debugLineNum = 192;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 193;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:234\")";
_i.Initialize(_i.ACTION_VIEW,"tel:234");
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 196;BA.debugLine="If a = 3 Then";
if (_a==3) { 
 //BA.debugLineNum = 197;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 198;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:01391814\")";
_i.Initialize(_i.ACTION_VIEW,"tel:01391814");
...
com.maximus.id.id _idd = null;
 //BA.debugLineNum = 326;BA.debugLine="Sub ct_Click";
 //BA.debugLineNum = 327;BA.debugLine="Dim lis As List";
_lis = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 328;BA.debugLine="Dim idd_int As Int";
_idd_int = 0;
 //BA.debugLineNum = 329;BA.debugLine="Dim idd As id";
_idd = new com.maximus.id.id();
 //BA.debugLineNum = 330;BA.debugLine="lis.Initialize";
_lis.Initialize();
 //BA.debugLineNum = 331;BA.debugLine="lis.AddAll(Array As String(\"Holo\",\"Holo Light\",\"H";
_lis.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Holo","Holo Light","Holo Light Dark","Old Android","Material","Material Light","Material Light Dark","Transparent","Transparent No Title Bar"}));
 //BA.debugLineNum = 332;BA.debugLine="idd_int = idd.InputList1(lis,\"Choose Themes!\")";
_idd_int = _idd.InputList1(_lis,"Choose Themes!",mostCurrent.activityBA);
 //BA.debugLineNum = 333;BA.debugLine="If idd_int = 0 Then";
if (_idd_int==0) { 
 //BA.debugLineNum = 334;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:sty";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Holo"));
 };
 //BA.debugLineNum = 337;BA.debugLine="If idd_int = 1 Then";
if (_idd_int==1) { 
 //BA.debugLineNum = 338;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:sty";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Holo.Light"));
 };
 //BA.debugLineNum = 341;BA.debugLine="If idd_int = 2 Then";
if (_idd_int==2) { 
 //BA.debugLineNum = 342;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:sty";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Holo.Light.DarkActionBar"));
 };
 //BA.debugLineNum = 345;BA.debugLine="If idd_int = 3 Then";
if (_idd_int==3) { 
 //BA.debugLineNum = 346;BA.debugLine="SetTheme(16973829)";
_settheme((int) (16973829));
 };
 //BA.debugLineNum = 349;BA.debugLine="If idd_int = 4 Then";
if (_idd_int==4) { 
 //BA.debugLineNum = 350;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:sty";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Material"));
 };
 //BA.debugLineNum = 353;BA.debugLine="If idd_int = 5 Then";
if (_idd_int==5) { 
 //BA.debugLineNum = 354;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:sty";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Material.Light"));
 };
 //BA.debugLineNum = 357;BA.debugLine="If idd_int = 6 Then";
if (_idd_int==6) { 
 //BA.debugLineNum = 358;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:sty";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Material.Light.DarkActionBar"));
 };
 //BA.debugLineNum = 361;BA.debugLine="If idd_int = 7 Then";
if (_idd_int==7) { 
 //BA.debugLineNum = 362;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:styl";
_settheme(mostCurrent._res.GetResourceId("style","android:style/Theme.Translucent"));
 };
 //BA.debugLineNum = 365;BA.debugLine="If idd_int = 8 Then";
if (_idd_int==8) { 
 //BA.debugLineNum = 366;BA.debugLine="SetTheme(res.GetResourceId(\"style\", \"android:styl";
...
anywheresoftware.b4a.objects.collections.List _li = null;
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 203;BA.debugLine="Sub fb_Click";
 //BA.debugLineNum = 204;BA.debugLine="Dim a As Int";
_a = 0;
 //BA.debugLineNum = 205;BA.debugLine="Dim b As id";
_b = new com.maximus.id.id();
 //BA.debugLineNum = 206;BA.debugLine="Dim li As List";
_li = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 207;BA.debugLine="li.Initialize";
_li.Initialize();
 //BA.debugLineNum = 208;BA.debugLine="li.AddAll(Array As String(\"Call TELENOR Operator\"";
_li.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Call TELENOR Operator","Call MPT Operator","Call OOREDOO Operator","Call MECTEL Operator"}));
 //BA.debugLineNum = 209;BA.debugLine="a = b.InputList1(li,\"Choose Your Operator!\")";
_a = _b.InputList1(_li,"Choose Your Operator!",mostCurrent.activityBA);
 //BA.debugLineNum = 210;BA.debugLine="If a = 0 Then";
if (_a==0) { 
 //BA.debugLineNum = 211;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 212;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:979\")";
_i.Initialize(_i.ACTION_VIEW,"tel:979");
 //BA.debugLineNum = 213;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 215;BA.debugLine="If a = 1 Then";
if (_a==1) { 
 //BA.debugLineNum = 216;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 217;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:106\")";
_i.Initialize(_i.ACTION_VIEW,"tel:106");
 //BA.debugLineNum = 218;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 220;BA.debugLine="If a = 2 Then";
if (_a==2) { 
 //BA.debugLineNum = 221;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 222;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:234\")";
_i.Initialize(_i.ACTION_VIEW,"tel:234");
 //BA.debugLineNum = 223;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 225;BA.debugLine="If a = 3 Then";
if (_a==3) { 
 //BA.debugLineNum = 226;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 227;BA.debugLine="i.Initialize(i.ACTION_VIEW, \"tel:01391814\")";
_i.Initialize(_i.ACTION_VIEW,"tel:01391814");
...
public static String  _fb1_click() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub fb1_Click";
 //BA.debugLineNum = 233;BA.debugLine="StartActivity(lollipop)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._lollipop.getObject()));
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 248;BA.debugLine="Sub help_Click";
 //BA.debugLineNum = 249;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 250;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 251;BA.debugLine="StartActivity(p.OpenBrowser(\"http://ht3tzn4ing.bl";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 418;BA.debugLine="Sub lblFooter_Click";
 //BA.debugLineNum = 419;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 420;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 421;BA.debugLine="StartActivity(p.OpenBrowser(\"https://www.facebook";
...
public static String  _mwadi_adfailedtoload(String _errorcode) throws Exception{
 //BA.debugLineNum = 410;BA.debugLine="Sub mwadi_AdFailedToLoad (ErrorCode As String)";
 //BA.debugLineNum = 411;BA.debugLine="Log(\"failed to load ad\")";
anywheresoftware.b4a.keywords.Common.Log("failed to load ad");
 //BA.debugLineNum = 412;BA.debugLine="End Sub";
return "";
}
public static String  _mwadi_adloaded() throws Exception{
 //BA.debugLineNum = 414;BA.debugLine="Sub mwadi_AdLoaded";
 //BA.debugLineNum = 415;BA.debugLine="Log(\"ad loaded\")";
...
public static String  _rad_click() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Sub rad_Click";
 //BA.debugLineNum = 166;BA.debugLine="t.Enabled = False";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 167;BA.debugLine="t1.Enabled = False";
...
public static String  _settheme(int _theme) throws Exception{
 //BA.debugLineNum = 371;BA.debugLine="Private Sub SetTheme (Theme As Int)";
 //BA.debugLineNum = 372;BA.debugLine="If Theme = 0 Then";
if (_theme==0) { 
 //BA.debugLineNum = 373;BA.debugLine="ToastMessageShow(\"Theme not available.\", False)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 376;BA.debugLine="If Theme = Theme_Value Then Return";
if (_theme==_theme_value) { 
if (true) return "";};
 //BA.debugLineNum = 377;BA.debugLine="Theme_Value = Theme";
_theme_value = _theme;
 //BA.debugLineNum = 378;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 379;BA.debugLine="StartActivity(Me)";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 236;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 237;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 238;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 239;BA.debugLine="copy.setText(\"#Myanmar_All_Sim_Register App! Regis";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_All_Sim_Register App! Registration you sim Free with this app. You can register all Myanmar sim Card, MPT, Telenor, Ooredoo, MecTel. Very simple useful App. Download Free at Google Play Store: https://play.google.com/store/apps/details?id=com.htetznaing.mmallsimregistration");
 //BA.debugLineNum = 240;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 241;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 242;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 243;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJEC";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 244;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\"";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 245;BA.debugLine="StartActivity (ShareIt)";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 266;BA.debugLine="Sub t_tick";
 //BA.debugLineNum = 267;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 268;BA.debugLine="If AdView2.Status=AdView2.Status_AdReadyToShow Th";
if (mostCurrent._adview2.Status==mostCurrent._adview2.Status_AdReadyToShow) { 
 //BA.debugLineNum = 269;BA.debugLine="AdView2.Show";
mostCurrent._adview2.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 272;BA.debugLine="If AdView2.Status=AdView2.Status_Dismissed Then";
if (mostCurrent._adview2.Status==mostCurrent._adview2.Status_Dismissed) { 
 //BA.debugLineNum = 273;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd(mostCurrent.activityBA);
 };
 };
...
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 253;BA.debugLine="Sub t1_tick";
 //BA.debugLineNum = 254;BA.debugLine="If ph.SdkVersion > 19 Then";
if (mostCurrent._ph.getSdkVersion()>19) { 
 //BA.debugLineNum = 255;BA.debugLine="If AdView2.Status=AdView2.Status_AdReadyToShow Th";
if (mostCurrent._adview2.Status==mostCurrent._adview2.Status_AdReadyToShow) { 
 //BA.debugLineNum = 256;BA.debugLine="AdView2.Show";
mostCurrent._adview2.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 259;BA.debugLine="If AdView2.Status=AdView2.Status_Dismissed Then";
if (mostCurrent._adview2.Status==mostCurrent._adview2.Status_Dismissed) { 
 //BA.debugLineNum = 260;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 262;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
