...
public class runads extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.htetznaing.mmallsimregistration", "com.htetznaing.mmallsimregistration.runads");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmallsimregistration.runads", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
_t.Initialize(processBA,"t",(long) (6000000));
 //BA.debugLineNum = 11;BA.debugLine="t.Enabled = True";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Sub t_Tick";
 //BA.debugLineNum = 15;BA.debugLine="StartActivity(Ads)";
