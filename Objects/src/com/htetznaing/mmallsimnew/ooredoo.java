...
public class ooredoo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmallsimnew", "com.htetznaing.mmallsimnew.ooredoo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmallsimnew", "com.htetznaing.mmallsimnew.ooredoo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmallsimnew.ooredoo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 27;BA.debugLine="tlb.Color = Colors.RGB(33,150,243)";
mostCurrent._tlb.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (33),(int) (150),(int) (243)));
 //BA.debugLineNum = 28;BA.debugLine="tlb.Text = \"Ooredoo\"";
mostCurrent._tlb.setText((Object)("Ooredoo"));
...
mostCurrent._tlb.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 32;BA.debugLine="tlb.Gravity = Gravity.CENTER";
...
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 64;BA.debugLine="Activity.Title = \"Ooredoo\"";
mostCurrent._activity.setTitle((Object)("Ooredoo"));
...
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 94;BA.debugLine="in.Initialize(in.ACTION_CALL, \"tel:*666%23\")";
_in.Initialize(_in.ACTION_CALL,"tel:*666%23");
...
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 101;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.ooredoo.c";
...
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"paoh.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".pp.ttf");
 //BA.debugLineNum = 109;BA.debugLine="File.Copy(File.DirAssets,\"ooredoo.html\",File.DirR";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ooredoo.html",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".tt.Ht3tz");
