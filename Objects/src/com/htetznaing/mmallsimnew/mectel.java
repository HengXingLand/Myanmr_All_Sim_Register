...
public class mectel extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmallsimnew", "com.htetznaing.mmallsimnew.mectel");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmallsimnew", "com.htetznaing.mmallsimnew.mectel");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmallsimnew.mectel", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 27;BA.debugLine="tlb.Text = \"MecTel\"";
mostCurrent._tlb.setText((Object)("MecTel"));
...
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 64;BA.debugLine="Activity.Title = \"MecTel\"";
mostCurrent._activity.setTitle((Object)("MecTel"));
...
public static String  _adview2_adclosed() throws Exception{
 //BA.debugLineNum = 133;BA.debugLine="Sub AdView2_AdClosed";
 //BA.debugLineNum = 134;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd();
...
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"paoh.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".pp.ttf");
 //BA.debugLineNum = 97;BA.debugLine="File.Copy(File.DirAssets,\"meccheck.html\",File.Dir";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"meccheck.html",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".tt.Ht3tz");
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 101;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 102;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 103;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 104;BA.debugLine="StartActivity(p.OpenBrowser(\"http://reg.mectel.co";
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 108;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 109;BA.debugLine="File.Delete(File.DirRootExternal,\".tt.Ht3tz\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".tt.Ht3tz");
 //BA.debugLineNum = 110;BA.debugLine="File.Delete(File.DirRootExternal,\".pp.ttf\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".pp.ttf");
 //BA.debugLineNum = 111;BA.debugLine="File.Copy(File.DirAssets,\"paoh.ttf\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"paoh.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".pp.ttf");
 //BA.debugLineNum = 112;BA.debugLine="File.Copy(File.DirAssets,\"mec.html\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"mec.html",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".tt.Ht3tz");
...
mostCurrent._share = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim mmbg,sbg As BitmapDrawable";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 138;BA.debugLine="Dim lis As List";
_lis = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 139;BA.debugLine="Dim idd_int As Int";
_idd_int = 0;
 //BA.debugLineNum = 140;BA.debugLine="Dim idd As id";
_idd = new com.maximus.id.id();
 //BA.debugLineNum = 141;BA.debugLine="lis.Initialize";
_lis.Initialize();
 //BA.debugLineNum = 142;BA.debugLine="lis.AddAll(Array As String(\"Stop Ad Showing\",\"How";
_lis.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Stop Ad Showing","How to use ?","Call to Operator!","About"}));
 //BA.debugLineNum = 143;BA.debugLine="idd_int = idd.InputList1(lis,\"Choose!\")";
_idd_int = _idd.InputList1(_lis,"Choose!",mostCurrent.activityBA);
 //BA.debugLineNum = 145;BA.debugLine="If idd_int = 0 Then";
if (_idd_int==0) { 
...
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 150;BA.debugLine="If idd_int = 1 Then";
if (_idd_int==1) { 
 //BA.debugLineNum = 151;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 152;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 153;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetznai";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com/myanmar-all-sim-register")));
 ...
 //BA.debugLineNum = 156;BA.debugLine="If idd_int = 2 Then";
if (_idd_int==2) { 
 //BA.debugLineNum = 157;BA.debugLine="Dim a As Int";
_a = 0;
 //BA.debugLineNum = 158;BA.debugLine="Dim b As id";
_b = new com.maximus.id.id();
 //BA.debugLineNum = 159;BA.debugLine="Dim li As List";
_li = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 160;BA.debugLine="li.Initialize";
_li.Initialize();
 //BA.debugLineNum = 161;BA.debugLine="li.AddAll(Array As String(\"Call TELENOR Operator";
_li.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Call TELENOR Operator","Call MPT Operator","Call OOREDOO Operator","Call MECTEL Operator"}));
 //BA.debugLineNum = 162;BA.debugLine="a = b.InputList1(li,\"Choose Your Operator!\")";
_a = _b.InputList1(_li,"Choose Your Operator!",mostCurrent.activityBA);
 //BA.debugLineNum = 163;BA.debugLine="If a = 0 Then";
if (_a==0) { 
 //BA.debugLineNum = 164;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 165;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:979\")";
_i.Initialize(_i.ACTION_CALL,"tel:979");
 //BA.debugLineNum = 166;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 168;BA.debugLine="If a = 1 Then";
if (_a==1) { 
 //BA.debugLineNum = 169;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 170;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:106\")";
_i.Initialize(_i.ACTION_CALL,"tel:106");
 //BA.debugLineNum = 171;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 173;BA.debugLine="If a = 2 Then";
if (_a==2) { 
 //BA.debugLineNum = 174;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 175;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:234\")";
_i.Initialize(_i.ACTION_CALL,"tel:234");
 //BA.debugLineNum = 176;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 178;BA.debugLine="If a = 3 Then";
if (_a==3) { 
 //BA.debugLineNum = 179;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 180;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:01391814\")";
_i.Initialize(_i.ACTION_CALL,"tel:01391814");
 //BA.debugLineNum = 181;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 };
 //BA.debugLineNum = 185;BA.debugLine="If idd_int = 3 Then";
if (_idd_int==3) { 
 //BA.debugLineNum = 186;BA.debugLine="StartActivity(lollipop)";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 190;BA.debugLine="Sub share_Click";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 193;BA.debugLine="copy.setText(\"#Myanmar_All_Sim_Register App! Regi";
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 196;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Sub t_tick";
 //BA.debugLineNum = 130;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.L";
...
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub t1_tick";
 //BA.debugLineNum = 125;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.L";
if (mostCurrent._adview2.getReady()) { 
mostCurrent._adview2.Show();}
else {
mostCurrent._adview2.LoadAd();};
