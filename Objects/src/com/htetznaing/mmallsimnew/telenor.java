...
public class telenor extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmallsimnew", "com.htetznaing.mmallsimnew.telenor");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmallsimnew", "com.htetznaing.mmallsimnew.telenor");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmallsimnew.telenor", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 27;BA.debugLine="tlb.Text = \"Telenor\"";
mostCurrent._tlb.setText((Object)("Telenor"));
...
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 64;BA.debugLine="Activity.Title = \"Telenor\"";
mostCurrent._activity.setTitle((Object)("Telenor"));
...
public static String  _adview2_adclosed() throws Exception{
 //BA.debugLineNum = 131;BA.debugLine="Sub AdView2_AdClosed";
 //BA.debugLineNum = 132;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd();
...
anywheresoftware.b4a.objects.IntentWrapper _in = null;
 ...
 //BA.debugLineNum = 93;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 94;BA.debugLine="Dim in As Intent";
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 95;BA.debugLine="in.Initialize(in.ACTION_CALL, \"tel:*979*3*3%23\")";
_in.Initialize(_in.ACTION_CALL,"tel:*979*3*3%23");
 //BA.debugLineNum = 96;BA.debugLine="StartActivity(in)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 99;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 100;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 101;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 102;BA.debugLine="StartActivity(p.OpenBrowser(\"https://ecaf.telenor";
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 106;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 107;BA.debugLine="File.Delete(File.DirRootExternal,\".tt.Ht3tz\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".tt.Ht3tz");
 //BA.debugLineNum = 108;BA.debugLine="File.Delete(File.DirRootExternal,\".pp.ttf\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".pp.ttf");
 //BA.debugLineNum = 109;BA.debugLine="File.Copy(File.DirAssets,\"paoh.ttf\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"paoh.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".pp.ttf");
 //BA.debugLineNum = 110;BA.debugLine="File.Copy(File.DirAssets,\"telenor.html\",File.DirR";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"telenor.html",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),".tt.Ht3tz");
 //BA.debugLineNum = 111;BA.debugLine="StartActivity(Tutorial)";
...
mostCurrent._bbg = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 16;BA.debugLine="Dim copy As BClipboard";
...
mostCurrent._adview2 = new anywheresoftware.b4a.admobwrapper.AdViewWrapper.InterstitialAdWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim tlb As Label";
mostCurrent._tlb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim menu,share As Button";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 135;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 136;BA.debugLine="Dim lis As List";
_lis = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 137;BA.debugLine="Dim idd_int As Int";
_idd_int = 0;
 //BA.debugLineNum = 138;BA.debugLine="Dim idd As id";
_idd = new com.maximus.id.id();
 //BA.debugLineNum = 139;BA.debugLine="lis.Initialize";
_lis.Initialize();
 //BA.debugLineNum = 140;BA.debugLine="lis.AddAll(Array As String(\"Stop Ad Showing\",\"How";
_lis.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Stop Ad Showing","How to use ?","Call to Operator!","About"}));
 //BA.debugLineNum = 141;BA.debugLine="idd_int = idd.InputList1(lis,\"Choose!\")";
_idd_int = _idd.InputList1(_lis,"Choose!",mostCurrent.activityBA);
 //BA.debugLineNum = 143;BA.debugLine="If idd_int = 0 Then";
if (_idd_int==0) { 
 //BA.debugLineNum = 144;BA.debugLine="t.Enabled = False";
_t.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 145;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 148;BA.debugLine="If idd_int = 1 Then";
if (_idd_int==1) { 
 //BA.debugLineNum = 149;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 150;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 151;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetznai";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com/myanmar-all-sim-register")));
 ...
 //BA.debugLineNum = 154;BA.debugLine="If idd_int = 2 Then";
if (_idd_int==2) { 
 //BA.debugLineNum = 155;BA.debugLine="Dim a As Int";
_a = 0;
 //BA.debugLineNum = 156;BA.debugLine="Dim b As id";
_b = new com.maximus.id.id();
 //BA.debugLineNum = 157;BA.debugLine="Dim li As List";
_li = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 158;BA.debugLine="li.Initialize";
_li.Initialize();
 //BA.debugLineNum = 159;BA.debugLine="li.AddAll(Array As String(\"Call TELENOR Operator";
_li.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Call TELENOR Operator","Call MPT Operator","Call OOREDOO Operator","Call MECTEL Operator"}));
 //BA.debugLineNum = 160;BA.debugLine="a = b.InputList1(li,\"Choose Your Operator!\")";
_a = _b.InputList1(_li,"Choose Your Operator!",mostCurrent.activityBA);
 //BA.debugLineNum = 161;BA.debugLine="If a = 0 Then";
if (_a==0) { 
 //BA.debugLineNum = 162;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 163;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:979\")";
_i.Initialize(_i.ACTION_CALL,"tel:979");
 //BA.debugLineNum = 164;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 166;BA.debugLine="If a = 1 Then";
if (_a==1) { 
 //BA.debugLineNum = 167;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 168;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:106\")";
_i.Initialize(_i.ACTION_CALL,"tel:106");
 //BA.debugLineNum = 169;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 171;BA.debugLine="If a = 2 Then";
if (_a==2) { 
 //BA.debugLineNum = 172;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 173;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:234\")";
_i.Initialize(_i.ACTION_CALL,"tel:234");
 //BA.debugLineNum = 174;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 176;BA.debugLine="If a = 3 Then";
if (_a==3) { 
 //BA.debugLineNum = 177;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 178;BA.debugLine="i.Initialize(i.ACTION_CALL, \"tel:01391814\")";
_i.Initialize(_i.ACTION_CALL,"tel:01391814");
 //BA.debugLineNum = 179;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 };
 //BA.debugLineNum = 183;BA.debugLine="If idd_int = 3 Then";
if (_idd_int==3) { 
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(lollipop)";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 188;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 189;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 190;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 191;BA.debugLine="copy.setText(\"#Myanmar_All_Sim_Register App! Regi";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_All_Sim_Register App! Registration you sim Free with this app. You can register all Myanmar sim Card, MPT, Telenor, Ooredoo, MecTel. Very simple useful App. Download Free at : http://www.htetznaing.com/myanmar-all-sim-register/");
 //BA.debugLineNum = 192;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 193;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 194;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 195;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 196;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 197;BA.debugLine="StartActivity (ShareIt)";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Sub t_tick";
 //BA.debugLineNum = 128;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.L";
...
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Sub t1_tick";
 //BA.debugLineNum = 123;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.L";
if (mostCurrent._adview2.getReady()) { 
mostCurrent._adview2.Show();}
else {
mostCurrent._adview2.LoadAd();};
 //BA.debugLineNum = 124;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
