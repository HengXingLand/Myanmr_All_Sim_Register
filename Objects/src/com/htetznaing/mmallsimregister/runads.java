...
public class runads extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.htetznaing.mmallsimregister", "com.htetznaing.mmallsimregister.runads");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmallsimregister.runads", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
